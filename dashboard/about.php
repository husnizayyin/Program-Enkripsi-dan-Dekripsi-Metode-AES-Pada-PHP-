...
?>
  ...
  <body class="sidebar-mini fixed">
    <div class="wrapper">
      <header class="main-header hidden-print"><a class="logo" href="index.php" style="font-size:13pt">Husni Zayyin</a>
      ...
      <div class="content-wrapper">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-body">
                <legend>Aplikasi Enkripsi dan Dekripsi </legend>
                <p>Program ini dibuat untuk memenuhi salah satu tugas mata kuliah Sistem Keamanan Komputer. <br>
                  dibuat oleh Husni Zayyin Ansori 1461600142 Fakultas Teknik Informatika Universitas 17 Agustus 1945 Surabaya</p>
              </div>
            </div>
          </div>
        </div>
