...
?>
  <head>
    <title>Halo, <?php echo $data['fullname']; ?> - Huani Zayyin </title>
    <meta charset="utf-8">
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-dashboard"></i> Statistik Aplikasi Enkripsi dan Dekripsi</h1>
          </div>
          <div>
            <ul class="breadcrumb">
  ...
  <div class="container-fluid">
    <p class="copyright">&copy; 2019. Husni Zayyin Ansori | 1461600142.</p>
  </div>
</footer>
      </div>
    </div>
